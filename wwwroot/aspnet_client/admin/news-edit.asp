    ...
    <tr>
      ...
      <td>&nbsp;
        <input name="content" style="display:none" id="content" value="<% =rs("main") %>" />
             <IFRAME ID="eWebEditor1" SRC="../eWebEditor4.4/ewebeditor.htm?id=content" FRAMEBORDER="0" SCROLLING="no" WIDTH="630" HEIGHT="425"></IFRAME>  
             </td>
    </tr>
    <tr>
      <td colspan="2" height="28" align="center">新闻类别：
        <label>
          <select name="leibie" size="1">
            <option value="公司新闻">公司新闻</option>
            <option value="媒体新闻">媒体新闻</option>
            <option value="图片新闻">图片新闻</option>
            <option value="特殊新闻">特殊新闻</option>
            </select>
          </label></td>
    </tr>
    <tr>
