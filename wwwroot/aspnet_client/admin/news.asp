...
%>
      <div id="layer222" style="text-align:left;">
       <%
	     do while not rs.eof
	   %>&nbsp;¡Ñ&nbsp;<a href="../news_1.asp?id=<%=rs("id")%>"><%=rs("title")%></a><font color="#666666" size="-6"><%=rs("time")%></font>&nbsp;&nbsp;&nbsp;<a href="news-delete.asp?id=<%=rs("id")%>">É¾³ı</a>&nbsp;&nbsp;&nbsp;<a href="news-edit.asp?id=<%=rs("id")%>">ĞŞ¸Ä</a><br />
      <%
        rs.movenext
        loop
        rs.close
