...
<div id="center">
   ...
   %>
       ...
       <div id="left1">
           ...
           <p style=" text-align:left; padding-left:0px; padding-top:10px;">
             <ul>
			 <%
			  set rs=server.CreateObject("adodb.recordset")
         ...
         <div id="right-bottom">
          <h1 id="title">联系我们</h1><br/>
            <table id="showtable">
				...
				%>
                    <tr>
                    	<td class="tar"><%=p_name%>:</td>
                        <td class="tal"><%=p_phone%></td>
                    </tr>
                <%
				rs.movenext
				loop
				...
				rs.close
				 %>
                	<tr>
                    	<td class="tar">电 话：</td>
                        <td class="tal"><%=c_phone%></td>
                    </tr>
                	<tr>
                    	<td class="tar">传 真：</td>
                        <td class="tal"><%=c_fax%></td>
                    </tr>
                	<tr>
                    	<td class="tar">网 址：</td>
                        <td class="tal">http://www.yuetgg.com</td>
                    </tr>
                	<tr>
                    	<td class="tar">地 址：</td>
                        <td class="tal"><%=c_addr%></td>
                    </tr>
                </tbody>
            </table>
         </div>
