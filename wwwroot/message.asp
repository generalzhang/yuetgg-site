...
<%
  if request("action")="add" then
    ...
    %>
    <script>
	alert=confirm("您的留言提交成功，我们会尽快答复您。");
    </script>
    <%
...
<TD>&nbsp;<INPUT value="sir" CHECKED type="radio" name="c_sex"> 男<INPUT value="lady" type="radio" name="c_sex"> 女</TD></TR>
<TR>
<TD height=20>
...
<DIV align=right>内容:<BR></DIV></TD>
<TD>&nbsp;<TEXTAREA rows="5" cols="60" name="c_content" id="ct" onmouseout="check('ct')"></TEXTAREA></TD></TR>
<TR>
<TD height=30 colSpan=2>
<DIV align=center><INPUT value="提交" type="submit" name="submit1"> &nbsp; <INPUT value="重写" type="reset" name="submit2"> 
