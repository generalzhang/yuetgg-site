...
<div id="center">
   ...
   %>
     ...
     <div id="right">
         ...
         <div id="right-bottom">
           <h1 id="title" align="center">人才招聘</h1>
           <br/>
           <%
             set rs=server.CreateObject("adodb.recordset")
   ...
   if rs.recordcount=0 then
     response.Write "<div style='padding-left=30px; padding-top=20px; width=600px;'>暂时没有相关信息</div>"
   else 
...
%>
   <div style="width:600px; height:25px;">
      <div style="width:420px; padding-left:30px; float:left; height:25px; color:#000;text-align:left; color:#000"><a href="recruit_content.asp?recruit_id=<%=rs("id")%>">>><%=rs("fname")%></a>
      </div>
      <div style="width:130px; padding-right:10px; float:left; height:25px;"><%=left(rs("time"),10)%></div>
   </div>
<%
      rs.movenext
	next
